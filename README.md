...
Dimensions is a React + TypeScript single-page application for managing interview evaluations. It integrates with a GraphQL back office, surfaces interview lists/details, and helps create structured conclusions per evaluation dimension. The project is also an experiment to learn and exercise the browser AI API in a real UI flow.
